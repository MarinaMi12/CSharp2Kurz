...
public class Banka
        ...
        public class Program
        {
            public static void Main()
            {
                ...
                // 2. Řešení
                List<int> nasobky4a6 = ruznaCisla.Where(x => x % 4 == 0 || x % 6 == 0).ToList();
            ...
            // 3. Kolik je v seznamu ruznaCisla čísel?
                ...
                Console.WriteLine($"Pocet cisej je {pocetCisel}");
            ...
            // 7. Řešení
                var milionar = zakaznici.Where(z => z.Zustatek >= 1000000);
                List<SkupinaMilionaru> skupinyPodleBanky = milionar.GroupBy(z => z.Banka).Select (g =>);
